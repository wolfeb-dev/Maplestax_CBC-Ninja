...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private MapleStaxCBC[] cacheMapleStaxCBC;
		public MapleStaxCBC MapleStaxCBC(MapleStaxChartTimeZone chartTz, bool showFobo, bool showEmaTouchDots, bool showVwap, bool showBrsgZone, Brush brsgColor, double brsgHighMult, double brsgLowMult, bool showLtfPivots, int ltfPivN, Brush ltfPivotResColor, Brush ltfPivotSupColor, int ltfPivWidth, MapleStaxRefLineStyle ltfPivStyle, bool showHtfEmaCloud, bool htfEnabled, string htfTimeframe, MapleStaxStatusTextSize htfLabelSize, bool showHtfCbcLabels, bool showHtfPivots, int htfPivN, Brush htfPivotResColor, Brush htfPivotSupColor, int htfPivWidth, MapleStaxRefLineStyle htfPivStyle, bool showBarColoring, int emaFastPeriod, int emaSlowPeriod, int emaTrendPeriod, int htfEmaFastPeriod, int htfEmaSlowPeriod, bool orNy, bool orLondon, bool orAsian, int orMinutes, bool showPdh, Brush pdhColor, int pdhWidth, MapleStaxRefLineStyle pdhStyle, bool showPdl, Brush pdlColor, int pdlWidth, MapleStaxRefLineStyle pdlStyle, bool showPmh, Brush pmhColor, int pmhWidth, MapleStaxRefLineStyle pmhStyle, bool showPml, Brush pmlColor, int pmlWidth, MapleStaxRefLineStyle pmlStyle, bool showLevelName, bool showLevelPrice, int extendLevelsBars, bool showBillBreaker, Brush billBreakerColor, int billBreakerMultiplier, bool showStatusTable, string statusTablePosition, MapleStaxStatusTextSize statusTableTextSize, int statusTableHeaderNewlines, Brush statusBullBg, Brush statusBearBg, Brush statusNeutralBg, Brush statusInsideBg, Brush statusHeaderBg, Brush statusLabelBg, Brush statusHeaderText, Brush statusLabelText, bool showCbcFlipLtf, Brush cbcFlipLtfHColor, Brush cbcFlipLtfLColor, int cbcFlipLtfWidth, bool showCbcFlipHtf, Brush cbcFlipHtfHColor, Brush cbcFlipHtfLColor, int cbcFlipHtfWidth)
		{
			return MapleStaxCBC(Input, chartTz, showFobo, showEmaTouchDots, showVwap, showBrsgZone, brsgColor, brsgHighMult, brsgLowMult, showLtfPivots, ltfPivN, ltfPivotResColor, ltfPivotSupColor, ltfPivWidth, ltfPivStyle, showHtfEmaCloud, htfEnabled, htfTimeframe, htfLabelSize, showHtfCbcLabels, showHtfPivots, htfPivN, htfPivotResColor, htfPivotSupColor, htfPivWidth, htfPivStyle, showBarColoring, emaFastPeriod, emaSlowPeriod, emaTrendPeriod, htfEmaFastPeriod, htfEmaSlowPeriod, orNy, orLondon, orAsian, orMinutes, showPdh, pdhColor, pdhWidth, pdhStyle, showPdl, pdlColor, pdlWidth, pdlStyle, showPmh, pmhColor, pmhWidth, pmhStyle, showPml, pmlColor, pmlWidth, pmlStyle, showLevelName, showLevelPrice, extendLevelsBars, showBillBreaker, billBreakerColor, billBreakerMultiplier, showStatusTable, statusTablePosition, statusTableTextSize, statusTableHeaderNewlines, statusBullBg, statusBearBg, statusNeutralBg, statusInsideBg, statusHeaderBg, statusLabelBg, statusHeaderText, statusLabelText, showCbcFlipLtf, cbcFlipLtfHColor, cbcFlipLtfLColor, cbcFlipLtfWidth, showCbcFlipHtf, cbcFlipHtfHColor, cbcFlipHtfLColor, cbcFlipHtfWidth);
		}

		public MapleStaxCBC MapleStaxCBC(ISeries<double> input, MapleStaxChartTimeZone chartTz, bool showFobo, bool showEmaTouchDots, bool showVwap, bool showBrsgZone, Brush brsgColor, double brsgHighMult, double brsgLowMult, bool showLtfPivots, int ltfPivN, Brush ltfPivotResColor, Brush ltfPivotSupColor, int ltfPivWidth, MapleStaxRefLineStyle ltfPivStyle, bool showHtfEmaCloud, bool htfEnabled, string htfTimeframe, MapleStaxStatusTextSize htfLabelSize, bool showHtfCbcLabels, bool showHtfPivots, int htfPivN, Brush htfPivotResColor, Brush htfPivotSupColor, int htfPivWidth, MapleStaxRefLineStyle htfPivStyle, bool showBarColoring, int emaFastPeriod, int emaSlowPeriod, int emaTrendPeriod, int htfEmaFastPeriod, int htfEmaSlowPeriod, bool orNy, bool orLondon, bool orAsian, int orMinutes, bool showPdh, Brush pdhColor, int pdhWidth, MapleStaxRefLineStyle pdhStyle, bool showPdl, Brush pdlColor, int pdlWidth, MapleStaxRefLineStyle pdlStyle, bool showPmh, Brush pmhColor, int pmhWidth, MapleStaxRefLineStyle pmhStyle, bool showPml, Brush pmlColor, int pmlWidth, MapleStaxRefLineStyle pmlStyle, bool showLevelName, bool showLevelPrice, int extendLevelsBars, bool showBillBreaker, Brush billBreakerColor, int billBreakerMultiplier, bool showStatusTable, string statusTablePosition, MapleStaxStatusTextSize statusTableTextSize, int statusTableHeaderNewlines, Brush statusBullBg, Brush statusBearBg, Brush statusNeutralBg, Brush statusInsideBg, Brush statusHeaderBg, Brush statusLabelBg, Brush statusHeaderText, Brush statusLabelText, bool showCbcFlipLtf, Brush cbcFlipLtfHColor, Brush cbcFlipLtfLColor, int cbcFlipLtfWidth, bool showCbcFlipHtf, Brush cbcFlipHtfHColor, Brush cbcFlipHtfLColor, int cbcFlipHtfWidth)
		{
			if (cacheMapleStaxCBC != null)
				for (int idx = 0; idx < cacheMapleStaxCBC.Length; idx++)
					if (cacheMapleStaxCBC[idx] != null && cacheMapleStaxCBC[idx].ChartTz == chartTz && cacheMapleStaxCBC[idx].ShowFobo == showFobo && cacheMapleStaxCBC[idx].ShowEmaTouchDots == showEmaTouchDots && cacheMapleStaxCBC[idx].ShowVwap == showVwap && cacheMapleStaxCBC[idx].ShowBrsgZone == showBrsgZone && cacheMapleStaxCBC[idx].BrsgColor == brsgColor && cacheMapleStaxCBC[idx].BrsgHighMult == brsgHighMult && cacheMapleStaxCBC[idx].BrsgLowMult == brsgLowMult && cacheMapleStaxCBC[idx].ShowLtfPivots == showLtfPivots && cacheMapleStaxCBC[idx].LtfPivN == ltfPivN && cacheMapleStaxCBC[idx].LtfPivotResColor == ltfPivotResColor && cacheMapleStaxCBC[idx].LtfPivotSupColor == ltfPivotSupColor && cacheMapleStaxCBC[idx].LtfPivWidth == ltfPivWidth && cacheMapleStaxCBC[idx].LtfPivStyle == ltfPivStyle && cacheMapleStaxCBC[idx].ShowHtfEmaCloud == showHtfEmaCloud && cacheMapleStaxCBC[idx].HtfEnabled == htfEnabled && cacheMapleStaxCBC[idx].HtfTimeframe == htfTimeframe && cacheMapleStaxCBC[idx].HtfLabelSize == htfLabelSize && cacheMapleStaxCBC[idx].ShowHtfCbcLabels == showHtfCbcLabels && cacheMapleStaxCBC[idx].ShowHtfPivots == showHtfPivots && cacheMapleStaxCBC[idx].HtfPivN == htfPivN && cacheMapleStaxCBC[idx].HtfPivotResColor == htfPivotResColor && cacheMapleStaxCBC[idx].HtfPivotSupColor == htfPivotSupColor && cacheMapleStaxCBC[idx].HtfPivWidth == htfPivWidth && cacheMapleStaxCBC[idx].HtfPivStyle == htfPivStyle && cacheMapleStaxCBC[idx].ShowBarColoring == showBarColoring && cacheMapleStaxCBC[idx].EmaFastPeriod == emaFastPeriod && cacheMapleStaxCBC[idx].EmaSlowPeriod == emaSlowPeriod && cacheMapleStaxCBC[idx].EmaTrendPeriod == emaTrendPeriod && cacheMapleStaxCBC[idx].HtfEmaFastPeriod == htfEmaFastPeriod && cacheMapleStaxCBC[idx].HtfEmaSlowPeriod == htfEmaSlowPeriod && cacheMapleStaxCBC[idx].OrNy == orNy && cacheMapleStaxCBC[idx].OrLondon == orLondon && cacheMapleStaxCBC[idx].OrAsian == orAsian && cacheMapleStaxCBC[idx].OrMinutes == orMinutes && cacheMapleStaxCBC[idx].ShowPdh == showPdh && cacheMapleStaxCBC[idx].PdhColor == pdhColor && cacheMapleStaxCBC[idx].PdhWidth == pdhWidth && cacheMapleStaxCBC[idx].PdhStyle == pdhStyle && cacheMapleStaxCBC[idx].ShowPdl == showPdl && cacheMapleStaxCBC[idx].PdlColor == pdlColor && cacheMapleStaxCBC[idx].PdlWidth == pdlWidth && cacheMapleStaxCBC[idx].PdlStyle == pdlStyle && cacheMapleStaxCBC[idx].ShowPmh == showPmh && cacheMapleStaxCBC[idx].PmhColor == pmhColor && cacheMapleStaxCBC[idx].PmhWidth == pmhWidth && cacheMapleStaxCBC[idx].PmhStyle == pmhStyle && cacheMapleStaxCBC[idx].ShowPml == showPml && cacheMapleStaxCBC[idx].PmlColor == pmlColor && cacheMapleStaxCBC[idx].PmlWidth == pmlWidth && cacheMapleStaxCBC[idx].PmlStyle == pmlStyle && cacheMapleStaxCBC[idx].ShowLevelName == showLevelName && cacheMapleStaxCBC[idx].ShowLevelPrice == showLevelPrice && cacheMapleStaxCBC[idx].ExtendLevelsBars == extendLevelsBars && cacheMapleStaxCBC[idx].ShowBillBreaker == showBillBreaker && cacheMapleStaxCBC[idx].BillBreakerColor == billBreakerColor && cacheMapleStaxCBC[idx].BillBreakerMultiplier == billBreakerMultiplier && cacheMapleStaxCBC[idx].ShowStatusTable == showStatusTable && cacheMapleStaxCBC[idx].StatusTablePosition == statusTablePosition && cacheMapleStaxCBC[idx].StatusTableTextSize == statusTableTextSize && cacheMapleStaxCBC[idx].StatusTableHeaderNewlines == statusTableHeaderNewlines && cacheMapleStaxCBC[idx].StatusBullBg == statusBullBg && cacheMapleStaxCBC[idx].StatusBearBg == statusBearBg && cacheMapleStaxCBC[idx].StatusNeutralBg == statusNeutralBg && cacheMapleStaxCBC[idx].StatusInsideBg == statusInsideBg && cacheMapleStaxCBC[idx].StatusHeaderBg == statusHeaderBg && cacheMapleStaxCBC[idx].StatusLabelBg == statusLabelBg && cacheMapleStaxCBC[idx].StatusHeaderText == statusHeaderText && cacheMapleStaxCBC[idx].StatusLabelText == statusLabelText && cacheMapleStaxCBC[idx].ShowCbcFlipLtf == showCbcFlipLtf && cacheMapleStaxCBC[idx].CbcFlipLtfHColor == cbcFlipLtfHColor && cacheMapleStaxCBC[idx].CbcFlipLtfLColor == cbcFlipLtfLColor && cacheMapleStaxCBC[idx].CbcFlipLtfWidth == cbcFlipLtfWidth && cacheMapleStaxCBC[idx].ShowCbcFlipHtf == showCbcFlipHtf && cacheMapleStaxCBC[idx].CbcFlipHtfHColor == cbcFlipHtfHColor && cacheMapleStaxCBC[idx].CbcFlipHtfLColor == cbcFlipHtfLColor && cacheMapleStaxCBC[idx].CbcFlipHtfWidth == cbcFlipHtfWidth && cacheMapleStaxCBC[idx].EqualsInput(input))
						return cacheMapleStaxCBC[idx];
			return CacheIndicator<MapleStaxCBC>(new MapleStaxCBC(){ ChartTz = chartTz, ShowFobo = showFobo, ShowEmaTouchDots = showEmaTouchDots, ShowVwap = showVwap, ShowBrsgZone = showBrsgZone, BrsgColor = brsgColor, BrsgHighMult = brsgHighMult, BrsgLowMult = brsgLowMult, ShowLtfPivots = showLtfPivots, LtfPivN = ltfPivN, LtfPivotResColor = ltfPivotResColor, LtfPivotSupColor = ltfPivotSupColor, LtfPivWidth = ltfPivWidth, LtfPivStyle = ltfPivStyle, ShowHtfEmaCloud = showHtfEmaCloud, HtfEnabled = htfEnabled, HtfTimeframe = htfTimeframe, HtfLabelSize = htfLabelSize, ShowHtfCbcLabels = showHtfCbcLabels, ShowHtfPivots = showHtfPivots, HtfPivN = htfPivN, HtfPivotResColor = htfPivotResColor, HtfPivotSupColor = htfPivotSupColor, HtfPivWidth = htfPivWidth, HtfPivStyle = htfPivStyle, ShowBarColoring = showBarColoring, EmaFastPeriod = emaFastPeriod, EmaSlowPeriod = emaSlowPeriod, EmaTrendPeriod = emaTrendPeriod, HtfEmaFastPeriod = htfEmaFastPeriod, HtfEmaSlowPeriod = htfEmaSlowPeriod, OrNy = orNy, OrLondon = orLondon, OrAsian = orAsian, OrMinutes = orMinutes, ShowPdh = showPdh, PdhColor = pdhColor, PdhWidth = pdhWidth, PdhStyle = pdhStyle, ShowPdl = showPdl, PdlColor = pdlColor, PdlWidth = pdlWidth, PdlStyle = pdlStyle, ShowPmh = showPmh, PmhColor = pmhColor, PmhWidth = pmhWidth, PmhStyle = pmhStyle, ShowPml = showPml, PmlColor = pmlColor, PmlWidth = pmlWidth, PmlStyle = pmlStyle, ShowLevelName = showLevelName, ShowLevelPrice = showLevelPrice, ExtendLevelsBars = extendLevelsBars, ShowBillBreaker = showBillBreaker, BillBreakerColor = billBreakerColor, BillBreakerMultiplier = billBreakerMultiplier, ShowStatusTable = showStatusTable, StatusTablePosition = statusTablePosition, StatusTableTextSize = statusTableTextSize, StatusTableHeaderNewlines = statusTableHeaderNewlines, StatusBullBg = statusBullBg, StatusBearBg = statusBearBg, StatusNeutralBg = statusNeutralBg, StatusInsideBg = statusInsideBg, StatusHeaderBg = statusHeaderBg, StatusLabelBg = statusLabelBg, StatusHeaderText = statusHeaderText, StatusLabelText = statusLabelText, ShowCbcFlipLtf = showCbcFlipLtf, CbcFlipLtfHColor = cbcFlipLtfHColor, CbcFlipLtfLColor = cbcFlipLtfLColor, CbcFlipLtfWidth = cbcFlipLtfWidth, ShowCbcFlipHtf = showCbcFlipHtf, CbcFlipHtfHColor = cbcFlipHtfHColor, CbcFlipHtfLColor = cbcFlipHtfLColor, CbcFlipHtfWidth = cbcFlipHtfWidth }, input, ref cacheMapleStaxCBC);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.MapleStaxCBC MapleStaxCBC(MapleStaxChartTimeZone chartTz, bool showFobo, bool showEmaTouchDots, bool showVwap, bool showBrsgZone, Brush brsgColor, double brsgHighMult, double brsgLowMult, bool showLtfPivots, int ltfPivN, Brush ltfPivotResColor, Brush ltfPivotSupColor, int ltfPivWidth, MapleStaxRefLineStyle ltfPivStyle, bool showHtfEmaCloud, bool htfEnabled, string htfTimeframe, MapleStaxStatusTextSize htfLabelSize, bool showHtfCbcLabels, bool showHtfPivots, int htfPivN, Brush htfPivotResColor, Brush htfPivotSupColor, int htfPivWidth, MapleStaxRefLineStyle htfPivStyle, bool showBarColoring, int emaFastPeriod, int emaSlowPeriod, int emaTrendPeriod, int htfEmaFastPeriod, int htfEmaSlowPeriod, bool orNy, bool orLondon, bool orAsian, int orMinutes, bool showPdh, Brush pdhColor, int pdhWidth, MapleStaxRefLineStyle pdhStyle, bool showPdl, Brush pdlColor, int pdlWidth, MapleStaxRefLineStyle pdlStyle, bool showPmh, Brush pmhColor, int pmhWidth, MapleStaxRefLineStyle pmhStyle, bool showPml, Brush pmlColor, int pmlWidth, MapleStaxRefLineStyle pmlStyle, bool showLevelName, bool showLevelPrice, int extendLevelsBars, bool showBillBreaker, Brush billBreakerColor, int billBreakerMultiplier, bool showStatusTable, string statusTablePosition, MapleStaxStatusTextSize statusTableTextSize, int statusTableHeaderNewlines, Brush statusBullBg, Brush statusBearBg, Brush statusNeutralBg, Brush statusInsideBg, Brush statusHeaderBg, Brush statusLabelBg, Brush statusHeaderText, Brush statusLabelText, bool showCbcFlipLtf, Brush cbcFlipLtfHColor, Brush cbcFlipLtfLColor, int cbcFlipLtfWidth, bool showCbcFlipHtf, Brush cbcFlipHtfHColor, Brush cbcFlipHtfLColor, int cbcFlipHtfWidth)
		{
			return indicator.MapleStaxCBC(Input, chartTz, showFobo, showEmaTouchDots, showVwap, showBrsgZone, brsgColor, brsgHighMult, brsgLowMult, showLtfPivots, ltfPivN, ltfPivotResColor, ltfPivotSupColor, ltfPivWidth, ltfPivStyle, showHtfEmaCloud, htfEnabled, htfTimeframe, htfLabelSize, showHtfCbcLabels, showHtfPivots, htfPivN, htfPivotResColor, htfPivotSupColor, htfPivWidth, htfPivStyle, showBarColoring, emaFastPeriod, emaSlowPeriod, emaTrendPeriod, htfEmaFastPeriod, htfEmaSlowPeriod, orNy, orLondon, orAsian, orMinutes, showPdh, pdhColor, pdhWidth, pdhStyle, showPdl, pdlColor, pdlWidth, pdlStyle, showPmh, pmhColor, pmhWidth, pmhStyle, showPml, pmlColor, pmlWidth, pmlStyle, showLevelName, showLevelPrice, extendLevelsBars, showBillBreaker, billBreakerColor, billBreakerMultiplier, showStatusTable, statusTablePosition, statusTableTextSize, statusTableHeaderNewlines, statusBullBg, statusBearBg, statusNeutralBg, statusInsideBg, statusHeaderBg, statusLabelBg, statusHeaderText, statusLabelText, showCbcFlipLtf, cbcFlipLtfHColor, cbcFlipLtfLColor, cbcFlipLtfWidth, showCbcFlipHtf, cbcFlipHtfHColor, cbcFlipHtfLColor, cbcFlipHtfWidth);
		}

		public Indicators.MapleStaxCBC MapleStaxCBC(ISeries<double> input , MapleStaxChartTimeZone chartTz, bool showFobo, bool showEmaTouchDots, bool showVwap, bool showBrsgZone, Brush brsgColor, double brsgHighMult, double brsgLowMult, bool showLtfPivots, int ltfPivN, Brush ltfPivotResColor, Brush ltfPivotSupColor, int ltfPivWidth, MapleStaxRefLineStyle ltfPivStyle, bool showHtfEmaCloud, bool htfEnabled, string htfTimeframe, MapleStaxStatusTextSize htfLabelSize, bool showHtfCbcLabels, bool showHtfPivots, int htfPivN, Brush htfPivotResColor, Brush htfPivotSupColor, int htfPivWidth, MapleStaxRefLineStyle htfPivStyle, bool showBarColoring, int emaFastPeriod, int emaSlowPeriod, int emaTrendPeriod, int htfEmaFastPeriod, int htfEmaSlowPeriod, bool orNy, bool orLondon, bool orAsian, int orMinutes, bool showPdh, Brush pdhColor, int pdhWidth, MapleStaxRefLineStyle pdhStyle, bool showPdl, Brush pdlColor, int pdlWidth, MapleStaxRefLineStyle pdlStyle, bool showPmh, Brush pmhColor, int pmhWidth, MapleStaxRefLineStyle pmhStyle, bool showPml, Brush pmlColor, int pmlWidth, MapleStaxRefLineStyle pmlStyle, bool showLevelName, bool showLevelPrice, int extendLevelsBars, bool showBillBreaker, Brush billBreakerColor, int billBreakerMultiplier, bool showStatusTable, string statusTablePosition, MapleStaxStatusTextSize statusTableTextSize, int statusTableHeaderNewlines, Brush statusBullBg, Brush statusBearBg, Brush statusNeutralBg, Brush statusInsideBg, Brush statusHeaderBg, Brush statusLabelBg, Brush statusHeaderText, Brush statusLabelText, bool showCbcFlipLtf, Brush cbcFlipLtfHColor, Brush cbcFlipLtfLColor, int cbcFlipLtfWidth, bool showCbcFlipHtf, Brush cbcFlipHtfHColor, Brush cbcFlipHtfLColor, int cbcFlipHtfWidth)
		{
			return indicator.MapleStaxCBC(input, chartTz, showFobo, showEmaTouchDots, showVwap, showBrsgZone, brsgColor, brsgHighMult, brsgLowMult, showLtfPivots, ltfPivN, ltfPivotResColor, ltfPivotSupColor, ltfPivWidth, ltfPivStyle, showHtfEmaCloud, htfEnabled, htfTimeframe, htfLabelSize, showHtfCbcLabels, showHtfPivots, htfPivN, htfPivotResColor, htfPivotSupColor, htfPivWidth, htfPivStyle, showBarColoring, emaFastPeriod, emaSlowPeriod, emaTrendPeriod, htfEmaFastPeriod, htfEmaSlowPeriod, orNy, orLondon, orAsian, orMinutes, showPdh, pdhColor, pdhWidth, pdhStyle, showPdl, pdlColor, pdlWidth, pdlStyle, showPmh, pmhColor, pmhWidth, pmhStyle, showPml, pmlColor, pmlWidth, pmlStyle, showLevelName, showLevelPrice, extendLevelsBars, showBillBreaker, billBreakerColor, billBreakerMultiplier, showStatusTable, statusTablePosition, statusTableTextSize, statusTableHeaderNewlines, statusBullBg, statusBearBg, statusNeutralBg, statusInsideBg, statusHeaderBg, statusLabelBg, statusHeaderText, statusLabelText, showCbcFlipLtf, cbcFlipLtfHColor, cbcFlipLtfLColor, cbcFlipLtfWidth, showCbcFlipHtf, cbcFlipHtfHColor, cbcFlipHtfLColor, cbcFlipHtfWidth);
		}
	}
