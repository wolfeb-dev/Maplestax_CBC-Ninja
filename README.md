...
- **Option zones** - Show toggle, preview toggle, bias source (HTF CBC or HTF EMA cloud), zone width (x ATR) and its ATR period, labels toggle, fill opacity, long/short colors.
