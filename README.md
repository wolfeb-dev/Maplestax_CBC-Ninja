...
- **Option zones** - Show toggle, preview toggle, bias source (HTF CBC or HTF EMA cloud), zone width (x ATR) and its ATR period, cutoff hour (ET), examples kept per side, labels toggle, fill opacity, long/short colors.
